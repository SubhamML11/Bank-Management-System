...
public class SignupThree  extends JFrame implements ActionListener  {
	...
	SignupThree(String formno){
		...
		c7= new JCheckBox("I hereby declared that the above details are correct to the best of my knowledge");
	...
	public void actionPerformed(ActionEvent ae) {
		if(ae.getSource()==submit) {
			...
			String cardnumber=""+ Math.abs((random.nextLong() % 90000000L) + 5040903600000000L);
